...
def apply_query(
    sql: SelectOfScalar[ActorEntity],
    query: ActorQuery,
    count: bool = False,
) -> SelectOfScalar[ActorEntity]:
    # sql = select(Actor)
