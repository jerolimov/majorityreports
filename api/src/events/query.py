...
def apply_query(
    sql: SelectOfScalar[EventEntity],
    query: EventQuery,
    count: bool = False,
) -> SelectOfScalar[EventEntity]:
    # sql = select(Event)
