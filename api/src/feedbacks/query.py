...
def apply_query(
    sql: SelectOfScalar[FeedbackEntity],
    query: FeedbackQuery,
    count: bool = False,
) -> SelectOfScalar[FeedbackEntity]:
    # sql = select(Feedback)
