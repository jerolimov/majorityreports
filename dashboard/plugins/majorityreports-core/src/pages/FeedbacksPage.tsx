...
import { Feedback, FeedbacksResult } from '@internal/backstage-plugin-majorityreports-common';
...
const columns: TableColumn<Feedback>[] = [
  {
    ...
    field: 'name',
    highlight: true,
    render: (data) => <Link to={`/namespaces/${data.namespace_name}/feedbacks/${data.name}`}>{data.name}</Link>
  },
  {
    title: 'Namespace',
...
export const TableContent = () => {
  ...
  const result = useQuery<FeedbacksResult>({
