...
import { Item, ItemsResult } from '@internal/backstage-plugin-majorityreports-common';
...
const columns: TableColumn<Item>[] = [
  {
    ...
    field: 'name',
    highlight: true,
    render: (data) => <Link to={`/namespaces/${data.namespace_name}/items/${data.name}`}>{data.name}</Link>
  },
  {
    title: 'Namespace',
...
export const TableContent = () => {
  ...
  const result = useQuery<ItemsResult>({
