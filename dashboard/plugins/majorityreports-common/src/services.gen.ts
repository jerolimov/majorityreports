 ...
 * Read Actors
 */
export const readActorsApiNamespacesNamespaceNameActorsGet = (options: Options<ReadActorsApiNamespacesNamespaceNameActorsGetData>) => { return (options?.client ?? client).get<ReadActorsApiNamespacesNamespaceNameActorsGetResponse, ReadActorsApiNamespacesNamespaceNameActorsGetError>({
    ...options,
    url: '/api/namespaces/{namespace_name}/actors'
}); };
